...
public class HomeActivity extends AppCompatActivity implements View {
    ...
    @BindView(R.id.image_unauthorized)
    ImageView unauthorizedImageView;
    ...
    @Override
    public void showUnauthorizedMessage(boolean show) {
        unauthorizedImageView.setVisibility(show ? VISIBLE : GONE);
