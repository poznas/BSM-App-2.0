...
import com.bsm.mobile.legacy.domain.professor.rate.sm.ProfRateSMPostActivity;
import com.bsm.mobile.legacy.domain.professor.rate.sm.ProfRateSideMissionActivity;
